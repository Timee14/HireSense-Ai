...
readme_content = """# 🌟 HireSense AI — Precision Resume Screening & Candidate Intelligence Platform
...
print("[+] Root README.md successfully created with Live Demo and Mobile guide!")
